  ...
  return (
    <Card className="mt-6 max-w-lg border-green-200 bg-green-50/50 dark:border-green-900 dark:bg-green-950/30">
      <CardHeader>
        ...
        <CardDescription>
          You can add products and receive payouts from Joe Perks orders.
        </CardDescription>
      </CardHeader>
      ...
      {stripeOnboarding === "RESTRICTED" ? (
        ...
        >
          <div className="flex items-start gap-2">
            ...
            />
            <p>
              Your Stripe account needs attention before you can accept
              payments. Contact Joe Perks support with your business details.
            </p>
          </div>
        </div>
      ) : null}
