    ...
    <ol className="space-y-3 border-zinc-200 border-l pl-4 dark:border-zinc-800">
      {events.map((e) => (
        <li className="relative" key={e.id}>
          <div className="absolute top-1.5 -left-[18px] h-2 w-2 rounded-full bg-zinc-400" />
          ...
          {e.payload != null && typeof e.payload === "object" ? (
            <pre className="mt-1 max-h-48 overflow-auto rounded bg-zinc-50 p-2 text-xs text-zinc-700 dark:bg-zinc-900 dark:text-zinc-200">
