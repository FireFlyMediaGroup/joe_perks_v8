# Sprint 7 — Cursor Agent Kickoff Prompt

Use this prompt to start a fresh Cursor session on the next Sprint 7 story. This version is tuned to kick off implementation immediately and should be paired with [`docs/sprint-7/cursor-agent-prompt.md`](./cursor-agent-prompt.md).

```text
You are starting Sprint 7 buyer accounts implementation in the Joe Perks repo.

This is a strict story-by-story execution workflow.

Before doing anything else:
1. Read `docs/sprint-7/cursor-agent-prompt.md`
2. Read `docs/sprint-7/README.md`
3. Read `docs/SPRINT_7_CHECKLIST.md`
4. Read `docs/SPRINT_7_PROGRESS.md`
5. Read `docs/sprint-7/buyer-accounts-epic-v3.md`
6. Read the next unfinished Sprint 7 story from `docs/sprint-7/stories/`
7. Read all directly relevant code files for that story
...
5. `docs/SPRINT_7_CHECKLIST.md` has been updated
6. `docs/SPRINT_7_PROGRESS.md` has been updated
7. `docs/sprint-7/README.md` has been updated if sprint-level context changed
...
- Determine the next unfinished Sprint 7 story in dependency order
- Summarize:
  - the selected story
...
If this is the very first Sprint 7 implementation session, start with:
- `docs/sprint-7/stories/US-09-00-buyer-account-foundation.md`

Do not begin coding until you have read the required Sprint 7 docs and confirmed the target story scope against the live codebase.
```
...
3. Let the agent select and execute exactly one Sprint 7 story.
