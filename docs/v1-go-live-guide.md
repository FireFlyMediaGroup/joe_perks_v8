...
| **13** | **$5 live smoke checkout** — smallest real charge on `https://joeperks.com/<org>/<campaign>` with agreed pilot or internal card                                                  | Stripe Dashboard: `payment_intent.succeeded`; prod DB: `Order` CONFIRMED; buyer confirmation email | **13**      |
