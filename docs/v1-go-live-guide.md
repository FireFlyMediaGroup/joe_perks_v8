...
| **1**    | Neon production snapshot; record snapshot ID                                         | A     | Not started        |            |     | ID: `__________________` — required before next prod write; not yet recorded (smoke lane ran 2026-06-29 without ID here) |
