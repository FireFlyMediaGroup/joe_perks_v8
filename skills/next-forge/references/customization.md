...
**Alternatives**:
- **Drizzle** — Replace Prisma schema with Drizzle schema definitions. Update `@repo-perks/db` exports to use Drizzle client.
...
To swap: update `packages/db/`, change the client export, and update `DATABASE_URL`.
...
1. **app** — Root directory: `apps/roaster`
2. **web** — Root directory: `apps/web`
3. **api** — Root directory: `apps/api`

For each project:
1. Import the repository in Vercel.
2. Set the Root Directory to the app's path (e.g., `apps/roaster`).
