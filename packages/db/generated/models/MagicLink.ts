...
export type MagicLinkModel =
  runtime.Types.Result.DefaultSelection<Prisma.$MagicLinkPayload>;
...
> = {
   ...
   */
  orderBy?:
    | Prisma.MagicLinkOrderByWithRelationInput
    | Prisma.MagicLinkOrderByWithRelationInput[];
  /**
...
type GetMagicLinkGroupByPayload<T extends MagicLinkGroupByArgs> =
...
export type MagicLinkWhereInput = {
  ...
  purpose?:
    | Prisma.EnumMagicLinkPurposeFilter<"MagicLink">
  ...
  payload?: Prisma.JsonFilter<"MagicLink">;
...
export type MagicLinkScalarWhereWithAggregatesInput = {
  ...
  dedupeKey?:
    | Prisma.StringNullableWithAggregatesFilter<"MagicLink">
    | string
    | null;
  purpose?:
    | Prisma.EnumMagicLinkPurposeWithAggregatesFilter<"MagicLink">
    | $Enums.MagicLinkPurpose;
  actorId?: Prisma.StringWithAggregatesFilter<"MagicLink"> | string;
  actorType?:
    | Prisma.EnumActorTypeWithAggregatesFilter<"MagicLink">
    | $Enums.ActorType;
  payload?: Prisma.JsonWithAggregatesFilter<"MagicLink">;
  expiresAt?: Prisma.DateTimeWithAggregatesFilter<"MagicLink"> | Date | string;
  usedAt?:
    | Prisma.DateTimeNullableWithAggregatesFilter<"MagicLink">
    | Date
    | string
    | null;
...
export type MagicLinkUpdateInput = {
  ...
  purpose?:
    | Prisma.EnumMagicLinkPurposeFieldUpdateOperationsInput
    | $Enums.MagicLinkPurpose;
...
export type MagicLinkGetPayload<
  S extends boolean | null | undefined | MagicLinkDefaultArgs,
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, MagicLinkGroupByArgs, OrderByArg> &
      InputErrors
  ): {} extends InputErrors
    ? GetMagicLinkGroupByPayload<T>
...
export interface MagicLinkFieldRefs {
  ...
  readonly payload: Prisma.FieldRef<"MagicLink", "Json">;
...
> = {
   ...
   */
  distinct?:
    | Prisma.MagicLinkScalarFieldEnum
    | Prisma.MagicLinkScalarFieldEnum[];
};
